...
export class InitialSchema1772223074537 implements MigrationInterface {
    name = 'InitialSchema1772223074537'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "product_variants" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "icon" character varying, "image" character varying, "sku" character varying, "productId" integer, CONSTRAINT "PK_281e3f2c55652d6a22c0aa59fd7" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "seller_offers" ("id" SERIAL NOT NULL, "price" numeric(12,2) NOT NULL, "discountPrice" numeric(12,2) NOT NULL, "stock" integer NOT NULL DEFAULT '0', "discountPercent" integer, "minOrder" integer, "maxOrder" integer, "sellerNotes" text, "hasWarranty" boolean, "warrantyDescription" character varying, "isDefault" boolean NOT NULL DEFAULT false, "isActive" boolean NOT NULL DEFAULT true, "sellerId" integer, "productId" integer, CONSTRAINT "PK_81b5f26bd647c43586e67dccfb8" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."category_spec_templates_type_enum" AS ENUM('text', 'number', 'range', 'select', 'boolean')`);
        await queryRunner.query(`CREATE TABLE "category_spec_templates" ("id" SERIAL NOT NULL, "categoryId" integer NOT NULL, "name" character varying NOT NULL, "key" character varying NOT NULL, "type" "public"."category_spec_templates_type_enum" NOT NULL DEFAULT 'text', "unit" character varying, "options" text, "filterable" boolean NOT NULL DEFAULT true, "displayOrder" integer NOT NULL DEFAULT '0', CONSTRAINT "PK_d2aee500d4a18588f9f9b9f503b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "product_spec_values" ("id" SERIAL NOT NULL, "productId" integer NOT NULL, "templateId" integer NOT NULL, "value" text NOT NULL, CONSTRAINT "PK_482200f0788006ece8bb829de86" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_1ce2f2ffcac2b1c82a3b6aede4" ON "product_spec_values" ("productId", "templateId") `);
        ...
        await queryRunner.query(`CREATE TABLE "comment" ("id" SERIAL NOT NULL, "content" text NOT NULL, "status" "public"."comment_status_enum" NOT NULL DEFAULT 'pending', "rating" smallint, "isAnonymous" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "authorId" integer, "postId" integer, "productId" integer, "parentId" integer, CONSTRAINT "PK_0b0e4bbc8415ec426f87f3a88e2" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "addresses" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "recipientName" character varying NOT NULL, "phone" character varying NOT NULL, "alternativePhone" character varying, "address" text NOT NULL, "city" character varying NOT NULL, "province" character varying NOT NULL, "postalCode" character varying(10) NOT NULL, "isDefault" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" integer, "userProfileId" integer, CONSTRAINT "PK_745d8f43d3af10ab8247465e450" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "user_profile" ("id" SERIAL NOT NULL, "bio" character varying, "avatar" character varying, "website" character varying, "location" character varying, "socialLinks" character varying, "phone" character varying, "alternativePhone" character varying, "address" text, "city" character varying, "province" character varying, "postalCode" character varying, "nationalId" character varying, "userId" integer, CONSTRAINT "REL_51cb79b5555effaf7d69ba1cff" UNIQUE ("userId"), CONSTRAINT "PK_f44d0cd18cfd80b0fed7806c3b7" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."settings_type_enum" AS ENUM('string', 'number', 'boolean', 'json', 'color', 'select', 'text', 'image')`);
        await queryRunner.query(`CREATE TYPE "public"."settings_group_enum" AS ENUM('general', 'ai', 'theme', 'shop_homepage', 'blog_homepage', 'seo')`);
        await queryRunner.query(`CREATE TABLE "settings" ("id" SERIAL NOT NULL, "key" character varying NOT NULL, "value" text NOT NULL DEFAULT '', "type" "public"."settings_type_enum" NOT NULL DEFAULT 'string', "group" "public"."settings_group_enum" NOT NULL DEFAULT 'general', "label" character varying NOT NULL, "description" character varying, "options" jsonb, "order" integer NOT NULL DEFAULT '0', "isPublic" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_c8639b7626fa94ba8265628f214" UNIQUE ("key"), CONSTRAINT "PK_0669fe20e252eb692bf4d344975" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "order_items" ("id" SERIAL NOT NULL, "productName" character varying NOT NULL, "productSlug" character varying, "productImage" character varying, "variantValueNames" character varying, "sellerBusinessName" character varying NOT NULL, "discountPrice" numeric(12,2), "discountPercent" integer NOT NULL DEFAULT '0', "minOrder" integer NOT NULL, "maxOrder" integer NOT NULL, "stock" integer NOT NULL, "hasWarranty" boolean NOT NULL DEFAULT false, "warrantyDescription" text, "selectedVariantId" integer, "selectedVariantValueId" integer, "selectedVariantObject" jsonb, "selectedVariantValueObject" jsonb, "quantity" integer NOT NULL, "price" numeric(12,2) NOT NULL, "subtotal" numeric(12,2) NOT NULL, "discount" numeric(12,2) NOT NULL DEFAULT '0', "total" numeric(12,2) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "orderId" integer, "productId" integer NOT NULL, "sellerId" integer NOT NULL, "offerId" integer NOT NULL, CONSTRAINT "PK_005269d8574e6fac0493715c308" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "orders" ("id" SERIAL NOT NULL, "orderNumber" character varying NOT NULL, "subtotal" numeric(12,2) NOT NULL, "shippingCost" numeric(12,2) NOT NULL DEFAULT '0', "discount" numeric(12,2) NOT NULL DEFAULT '0', "tax" numeric(12,2) NOT NULL DEFAULT '0', "total" numeric(12,2) NOT NULL, "status" "public"."orders_status_enum" NOT NULL DEFAULT 'pending', "paymentMethod" "public"."orders_paymentmethod_enum" NOT NULL DEFAULT 'online', "paymentStatus" "public"."orders_paymentstatus_enum" NOT NULL DEFAULT 'pending', "transactionId" character varying, "paidAt" TIMESTAMP, "shippingAddress" text NOT NULL, "shippingPhone" character varying, "recipientName" character varying, "trackingNumber" character varying, "carrier" character varying, "shippedAt" TIMESTAMP, "deliveredAt" TIMESTAMP, "customerNote" text, "adminNote" text, "cancelReason" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" integer NOT NULL, CONSTRAINT "UQ_59b0c3b34ea0fa5562342f24143" UNIQUE ("orderNumber"), CONSTRAINT "PK_710e2d4957aa5878dfe94e4ac2f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."payment_logs_status_enum" AS ENUM('pending', 'completed', 'failed', 'refunded')`);
        await queryRunner.query(`CREATE TABLE "payment_logs" ("id" SERIAL NOT NULL, "orderId" integer NOT NULL, "status" "public"."payment_logs_status_enum" NOT NULL DEFAULT 'pending', "amount" numeric(12,2) NOT NULL, "transactionId" character varying, "gateway" character varying, "gatewayResponse" character varying, "errorMessage" text, "referenceCode" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_b5bda25324e539ea41bc09697f6" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "category_spec_templates" ADD CONSTRAINT "FK_0a2f632a7afcddc9639048e5138" FOREIGN KEY ("categoryId") REFERENCES "product_categories"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "product_spec_values" ADD CONSTRAINT "FK_f2f8f376b02a3c2a049136e1383" FOREIGN KEY ("productId") REFERENCES "products"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "product_spec_values" ADD CONSTRAINT "FK_8c72d8b795371ffbeb7717e8532" FOREIGN KEY ("templateId") REFERENCES "category_spec_templates"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "addresses" ADD CONSTRAINT "FK_9667d61ea82200d48b72a81c01e" FOREIGN KEY ("userProfileId") REFERENCES "user_profile"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "payment_logs" ADD CONSTRAINT "FK_34a006a8dfe9c637c8d0f4fec01" FOREIGN KEY ("orderId") REFERENCES "orders"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "payment_logs" DROP CONSTRAINT "FK_34a006a8dfe9c637c8d0f4fec01"`);
        ...
        await queryRunner.query(`ALTER TABLE "addresses" DROP CONSTRAINT "FK_9667d61ea82200d48b72a81c01e"`);
        ...
        await queryRunner.query(`ALTER TABLE "product_spec_values" DROP CONSTRAINT "FK_8c72d8b795371ffbeb7717e8532"`);
        await queryRunner.query(`ALTER TABLE "product_spec_values" DROP CONSTRAINT "FK_f2f8f376b02a3c2a049136e1383"`);
        await queryRunner.query(`ALTER TABLE "category_spec_templates" DROP CONSTRAINT "FK_0a2f632a7afcddc9639048e5138"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."payment_logs_status_enum"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."settings_group_enum"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_1ce2f2ffcac2b1c82a3b6aede4"`);
        await queryRunner.query(`DROP TABLE "product_spec_values"`);
        await queryRunner.query(`DROP TABLE "category_spec_templates"`);
        await queryRunner.query(`DROP TYPE "public"."category_spec_templates_type_enum"`);
